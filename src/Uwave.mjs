...
import { i18n } from './locale.mjs';
import models from './models/index.mjs';
import configStore from './plugins/configStore.mjs';
import booth from './plugins/booth.mjs';
import chat from './plugins/chat.mjs';
import motd from './plugins/motd.mjs';
import playlists from './plugins/playlists.mjs';
import users from './plugins/users.mjs';
import bans from './plugins/bans.mjs';
import history from './plugins/history.mjs';
import acl from './plugins/acl.mjs';
import waitlist from './plugins/waitlist.mjs';
import passport from './plugins/passport.mjs';
import migrations from './plugins/migrations.mjs';
